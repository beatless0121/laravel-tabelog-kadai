                    ...
                    <div class="col">
                        <div class="card bg-light">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">{{ $total_members }}名</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card bg-light">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">{{ $total_free_members }}名</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card bg-light">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">{{ $total_premium_members }}名</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card bg-light">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">{{ $total_shops }}件</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
