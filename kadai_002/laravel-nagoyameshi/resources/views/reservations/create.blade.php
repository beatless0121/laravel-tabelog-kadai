...
@push('scripts')
    ...
    <script>
        ...
        const shopRegularHolidays = @json($shop->regular_holidays()->pluck('day_index'));
    </script>
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10">
                ...
                <ul class="nav nav-tabs mb-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-white nagoyameshi-bg" aria-current="page" href="{{ route('shops.reservations.create', $shop) }}">予約</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="reservation_time" name="reservation_time">
                                ...
                                @for ($i = 0; $i <= (strtotime($shop->closing_time) - strtotime($shop->opening_time)) / 1800; $i++)
                                    {{ $reservation_time = date('H:i', strtotime($shop->opening_time . '+' . $i * 30 . 'minute')) }}
