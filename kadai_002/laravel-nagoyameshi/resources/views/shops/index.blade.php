    ...
    <div class="container nagoyameshi-container pb-5">
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-md-12">
                <form method="GET" action="{{ route('shops.index') }}" class="w-100 mb-3">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('shops.index') }}" class="w-100">
            ...
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap">
                    <p class="fs-5 mb-3">
                        ...
                        <span class="fs-6">
                            @if ($total > 15)
                                （{{ 15 * $shops->currentPage() - 14 }}～{{ 15 * $shops->currentPage() }}件）
                            @endif
                        </span>
                    </p>
                    <form method="GET" action="{{ route('shops.index') }}" class="mb-3 nagoyameshi-sort-box">
                        @if ($keyword)
                ...
                @foreach ($shops as $shop)
                    <div class="mb-3">
                        <a href="{{ route('shops.show', $shop) }}" class="link-dark nagoyameshi-card-link">
                            <div class="card h-100">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        @if ($shop->image !== '')
                                            <img src="{{ asset('storage/shops/' . $shop->image) }}" class="card-img-top nagoyameshi-horizontal-card-image">
                                        @else
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">{{ mb_substr($shop->description, 0, 75) }}@if (mb_strlen($shop->description) > 75)...@endif</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
