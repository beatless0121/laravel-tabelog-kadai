                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($favorite_shops as $favorite_shop)
                            <tr>
                                <td>
                                    <a href="{{ route('shops.show', $favorite_shop) }}">
                                        {{ $favorite_shop->name }}
                                    </a>
                                </td>
                                <td>{{ substr($favorite_shop->postal_code, 0, 3) . '-' . substr($favorite_shop->postal_code, 3) }}</td>
                                <td>{{ $favorite_shop->address }}</td>
                                <td>
                                    <a href="#" class="link-secondary" data-bs-toggle="modal" data-bs-target="#removeFavoriteModal" data-shop-id="{{ $favorite_shop->id }}" data-shop-name="{{ $favorite_shop->name }}">解除</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
